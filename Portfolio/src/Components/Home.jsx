    ...
    return (
        <div name="home" className='grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] md:h-[70vh] mx-auto py-8 bg-black'>
            ...
            <div className='col-span-2 px-5 my-auto'>
                ...
                <div className='my-8'>
                    <a href='https://drive.google.com/file/d/1EgUjJNnW6w70xxQN1wTB7LD-e8MB0G6M/view' className='px-6 py-3 w-full rounded-xl mr-4 bg-gradient-to-br from-orange-500 to-pink-500 text-white'>Download CV</a>
