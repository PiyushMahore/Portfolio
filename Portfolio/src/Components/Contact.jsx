...
function Contact() {
  return (
    <div name='contact' className='max-w-[1200px] mx-auto bg-black sm:py-20 p-5'>
        ...
        <div className='max-w-[800px] mx-auto'>
            <div className='mt-6 bg-[#161616] rounded-xl'>
                <div className='p-10'>
                    <form action='https://getform.io/f/pagxvqkb' method='POST'>
                        <div className='grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4'>
                            ...
                            <div className='sm:col-span-2'>
                                <div className='mt-2.5'>
                                    <textarea name='message' placeholder='Your Message' className='bg-[#161616] w-full p-4 py-4 text-gray-400 placeholder-gray-400 border border-gray-700 rounded-md focus:outline-none focus:border-pink-600' rows='4'>
                                    </textarea>
                                </div>
                            </div>
                            <div className='sm:col-span-2'>
